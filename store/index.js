...
const store = new Vuex.Store({
  ...
  mutations: {
    // 更新token
    toggleIsToken (state, isToken) {
      state.isToken = typeof isToken === 'undefined' ? !state.isToken : isToken
    },
    updateUserInfo (state, hasUser) {
      state.hasUser = hasUser
    },
    updateIndexModal (state, isShow) {
      state.showIndexModal = isShow
    },
